/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   +
   + $Source: C:\\CVS_Repository/CybonTailTNG/shared/BlowFish.cpp,v $
   + $Author: volker $
...
// Encode pIntput into pOutput.  
// Input length in lSize.  
// Returned value is length of output which will be even MOD 8 bytes.
// Input buffer and output buffer can be the same, but 
// be sure buffer length is even MOD8.
